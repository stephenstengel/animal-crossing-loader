...
TRAIN_DATASET_COPY_FOLDER_DEER_ELK = os.path.join(TRAIN_DATASET_COPY_FOLDER, CLASS_DEER_ELK_STRING)

VAL_DATASET_COPY_FOLDER = os.path.normpath("./tmpValidationData/")
VAL_DATASET_COPY_FOLDER_COYOTE = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_COYOTE_STRING)
VAL_DATASET_COPY_FOLDER_ELK = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_ELK_STRING)
VAL_DATASET_COPY_FOLDER_HUMAN = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_HUMAN_STRING)
VAL_DATASET_COPY_FOLDER_BOBCAT = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_BOBCAT_STRING)
VAL_DATASET_COPY_FOLDER_DEER = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_DEER_STRING)
VAL_DATASET_COPY_FOLDER_RACCOON = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_RACCOON_STRING)
VAL_DATASET_COPY_FOLDER_WEASEL = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_WEASEL_STRING)
VAL_DATASET_COPY_FOLDER_NOT = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_NOT_INTERESTING_STRING)
VAL_DATASET_COPY_FOLDER_DEER_ELK = os.path.join(VAL_DATASET_COPY_FOLDER, CLASS_DEER_ELK_STRING)
...
TEST_DATASET_COPY_FOLDER_DEER_ELK = os.path.join(TEST_DATASET_COPY_FOLDER, CLASS_DEER_ELK_STRING)
...
DATASET_PNG_FOLDER_TRAIN_DEER_ELK = os.path.join(DATASET_PNG_FOLDER_TRAIN, CLASS_DEER_ELK_STRING)
...
DATASET_PNG_FOLDER_VAL_DEER_ELK = os.path.join(DATASET_PNG_FOLDER_VAL, CLASS_DEER_ELK_STRING)
...
DATASET_PNG_FOLDER_TEST_DEER_ELK = os.path.join(DATASET_PNG_FOLDER_TEST, CLASS_DEER_ELK_STRING)
...
ALL_FOLDERS_LIST = [
		...
		VAL_DATASET_COPY_FOLDER,
		VAL_DATASET_COPY_FOLDER_COYOTE,
		VAL_DATASET_COPY_FOLDER_ELK,
		VAL_DATASET_COPY_FOLDER_HUMAN,
		VAL_DATASET_COPY_FOLDER_BOBCAT,
		VAL_DATASET_COPY_FOLDER_DEER,
		VAL_DATASET_COPY_FOLDER_RACCOON,
		VAL_DATASET_COPY_FOLDER_WEASEL,
		VAL_DATASET_COPY_FOLDER_NOT,
...
if IS_COMBINED_DEEK_ELK:
	ALL_FOLDERS_LIST = [
		...
		TRAIN_DATASET_COPY_FOLDER,
		TRAIN_DATASET_COPY_FOLDER_COYOTE,
		TRAIN_DATASET_COPY_FOLDER_DEER_ELK,
		TRAIN_DATASET_COPY_FOLDER_HUMAN,
		TRAIN_DATASET_COPY_FOLDER_BOBCAT,
		TRAIN_DATASET_COPY_FOLDER_RACCOON,
		TRAIN_DATASET_COPY_FOLDER_WEASEL,
		...
		VAL_DATASET_COPY_FOLDER,
		VAL_DATASET_COPY_FOLDER_COYOTE,
		VAL_DATASET_COPY_FOLDER_DEER_ELK,
		VAL_DATASET_COPY_FOLDER_HUMAN,
		VAL_DATASET_COPY_FOLDER_BOBCAT,
		VAL_DATASET_COPY_FOLDER_RACCOON,
		VAL_DATASET_COPY_FOLDER_WEASEL,
		...
		TEST_DATASET_COPY_FOLDER,
		TEST_DATASET_COPY_FOLDER_COYOTE,
		TEST_DATASET_COPY_FOLDER_DEER_ELK,
		TEST_DATASET_COPY_FOLDER_HUMAN,
		TEST_DATASET_COPY_FOLDER_BOBCAT,
		TEST_DATASET_COPY_FOLDER_RACCOON,
		TEST_DATASET_COPY_FOLDER_WEASEL,
		...
		DATASET_PNG_FOLDER_TRAIN,
		DATASET_PNG_FOLDER_TRAIN_COYOTE,
		DATASET_PNG_FOLDER_TRAIN_DEER_ELK,
		DATASET_PNG_FOLDER_TRAIN_HUMAN,
		DATASET_PNG_FOLDER_TRAIN_BOBCAT,
		DATASET_PNG_FOLDER_TRAIN_RACCOON,
		DATASET_PNG_FOLDER_TRAIN_WEASEL,
		...
		DATASET_PNG_FOLDER_VAL,
		DATASET_PNG_FOLDER_VAL_COYOTE,
		DATASET_PNG_FOLDER_VAL_DEER_ELK,
		DATASET_PNG_FOLDER_VAL_HUMAN,
		DATASET_PNG_FOLDER_VAL_BOBCAT,
		DATASET_PNG_FOLDER_VAL_RACCOON,
		DATASET_PNG_FOLDER_VAL_WEASEL,
		...
		DATASET_PNG_FOLDER_TEST,
		DATASET_PNG_FOLDER_TEST_COYOTE,
		DATASET_PNG_FOLDER_TEST_DEER_ELK,
		DATASET_PNG_FOLDER_TEST_HUMAN,
		DATASET_PNG_FOLDER_TEST_BOBCAT,
		DATASET_PNG_FOLDER_TEST_RACCOON,
		DATASET_PNG_FOLDER_TEST_WEASEL,
...
def main(args):
	...
	num_deer_elk = 0
	if (IS_COMBINED_DEEK_ELK):
		num_deer_elk += createFileStructure(INTERESTING_ELK_DIRECTORY, TRAIN_DATASET_COPY_FOLDER_DEER_ELK)
		num_deer_elk += createFileStructure(INTERESTING_DEER_DIRECTORY, TRAIN_DATASET_COPY_FOLDER_DEER_ELK)
	else:
	...
	dataSplit(TRAIN_DATASET_COPY_FOLDER, TEST_DATASET_COPY_FOLDER, PERCENTAGE_TEST)
	# split into training and validation
	dataSplit(TRAIN_DATASET_COPY_FOLDER, VAL_DATASET_COPY_FOLDER, PERCENTAGE_VAL_FROM_TRAIN)

	# only duplicate training
	if IS_DUPLICATE_IMAGES:
		print("Duplicating images...")
		nums = [num_coyote, num_elk, num_human, num_bobcat, num_deer, num_deer, num_raccoon, num_weasel, num_not, num_deer_elk]
		max_num = round(max(nums) *  (1 - PERCENTAGE_TEST) * (1 - PERCENTAGE_VAL_FROM_TRAIN))
		...
		if IS_COMBINED_DEEK_ELK:
			duplicateImages(TRAIN_DATASET_COPY_FOLDER_DEER_ELK, max_num)
	...
	getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_COYOTE)
	getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_HUMAN)
	getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_BOBCAT)
	getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_RACCOON)
	getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_WEASEL)
	getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_NOT)
	if IS_COMBINED_DEEK_ELK:
		getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_DEER_ELK)
	else:
		getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_ELK)
		getListOfAnimalPicsInOneClass(TRAIN_DATASET_COPY_FOLDER_DEER)

	print("creating the datasets...")
	train_ds, val_ds, test_ds = createAnimalsDataset(
			TRAIN_DATASET_COPY_FOLDER, VAL_DATASET_COPY_FOLDER, TEST_DATASET_COPY_FOLDER, IMG_HEIGHT, IMG_WIDTH, BATCH_SIZE, PERCENTAGE_VAL_FROM_TRAIN)
	print("Done!")
	...
	shutil.rmtree(VAL_DATASET_COPY_FOLDER)
...
def makeDirectories(listOfFoldersToCreate):
	#Clear out old files -- Just in Case
	...
	if os.path.isdir(VAL_DATASET_COPY_FOLDER):
		shutil.rmtree(VAL_DATASET_COPY_FOLDER, ignore_errors = True)
...
def dataSplit(trainDirectory, testDirectory, percentageTest):
...
def createAnimalsDataset(trainDirectory, valDirectory, testDirectory, img_height, img_width, batch_size, percentageValToTrain):
	...
	if IS_DATA_AUGMENTATION:
		myFlip = tf.keras.layers.experimental.preprocessing.RandomFlip("horizontal")
		train_ds = train_ds.map(lambda x, y: (myFlip(x), y),  num_parallel_calls=AUTOTUNE)
